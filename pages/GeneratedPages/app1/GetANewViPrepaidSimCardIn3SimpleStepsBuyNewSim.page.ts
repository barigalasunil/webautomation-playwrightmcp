...
export class GetANewViPrepaidSimCardIn3SimpleStepsBuyNewSim {
  readonly page: Page;
  ...
  get heading98xxxxxx98OraSimilarFancyNumbercanBeYours(): Locator {
    return this.page.getByRole('heading', { name: "98XXXXXX98 ora similar fancy numbercan be yours" });
  }
  ...
  get link98xxxxxx98OraSimilarFancyNumbercanBeYoursChooseYour(): Locator {
    return this.page.locator('a[href="https://www.myvi.in/new-connection/choose-your-fancy-mobile-numbers-online"]');
  }
