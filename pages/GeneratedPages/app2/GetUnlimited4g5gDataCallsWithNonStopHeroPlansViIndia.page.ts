...
export class GetUnlimited4g5gDataCallsWithNonStopHeroPlansViIndia {
  readonly page: Page;
  readonly url = "https://www.myvi.in/non-stop-hero-unlimited-data-plans";

  // All element locators are generated dynamically using locator strategies

  get headingViNonstopHeroUnlimitedDataPlans(): Locator {
    return this.page.getByRole('heading', { name: "Vi NonStop Hero Unlimited Data Plans" });
  }
  ...
  get headingViNonstopHeroUnlimitedDataPlans1(): Locator {
    return this.page.getByRole('heading', { name: "Vi NonStop Hero Unlimited Data Plans" });
  }

  get headingEndlessConnectivityWithNonstopHeroPrepaidPacks(): Locator {
    return this.page.getByRole('heading', { name: "Endless Connectivity with NonStop Hero Prepaid Packs" });
  }

  get headingWhyUnlimitedDataMakesADifference(): Locator {
    return this.page.getByRole('heading', { name: "Why Unlimited Data Makes a Difference" });
  }

  get headingWhatToWatchWithUnlimitedInternetOttsAtNoExtraCost(): Locator {
    return this.page.getByRole('heading', { name: "What to Watch with Unlimited Internet + OTTs at No Extra Cost" });
  }

  get headingHowToRechargeWithViNonstopHeroPlans(): Locator {
    return this.page.getByRole('heading', { name: "How to Recharge with Vi NonStop Hero Plans" });
  }
  ...
  get linkViNonstopHeroRechargePlans(): Locator {
    return this.page.getByRole('link', { name: "Vi NonStop Hero Recharge Plans" });
  }
  ...
  get linkOttSubscriptions(): Locator {
    return this.page.getByRole('link', { name: "OTT subscriptions" });
  }
  ...
  get link5gData(): Locator {
    return this.page.getByRole('link', { name: "5G Data" });
  }
  ...
  get buttonKarnataka(): Locator {
    return this.page.getByRole('button', { name: "Karnataka" });
  }
  ...
  get menuHomeprepaidviNonstopHeroRechargePlans(): Locator {
    return this.page.getByRole('navigation', { name: "HomeprepaidVi NonStop Hero Recharge Plans" });
  }
