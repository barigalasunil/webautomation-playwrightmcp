...
export class ViRechargePlansWith365DaysValidity2026Upto3gbDayViIndia {
  readonly page: Page;
  readonly url = "https://www.myvi.in/prepaid/vi-365-days-recharge-plans";

  // All element locators are generated dynamically using locator strategies

  get headingVi365DaysPlans(): Locator {
    return this.page.getByRole('heading', { name: "Vi 365 Days Plans" });
  }

  get heading365Days(): Locator {
    return this.page.getByRole('heading', { name: "365 Days" });
  }
  ...
  get linkVi365DaysRechargePlans(): Locator {
    return this.page.getByRole('link', { name: "Vi 365 Days Recharge Plans" });
  }
  ...
  get button28Days(): Locator {
    return this.page.getByRole('button', { name: "28 Days" });
  }

  get button56Days(): Locator {
    return this.page.getByRole('button', { name: "56 Days" });
  }

  get button84Days(): Locator {
    return this.page.getByRole('button', { name: "84 Days" });
  }

  get button365Days(): Locator {
    return this.page.getByRole('button', { name: "365 Days" });
  }
  ...
  get menuHomeprepaidvi365DaysRechargePlans(): Locator {
    return this.page.getByRole('navigation', { name: "HomeprepaidVi 365 Days Recharge Plans" });
  }
