...
export class ViVodafoneIdeaLoginManageAccountOnlineMyViVodafoneIdeaLogin {
  readonly page: Page;
  readonly url = "https://www.myvi.in/account/login";

  // All element locators are generated dynamically using locator strategies

  get headingSignInToVi(): Locator {
    return this.page.getByRole('heading', { name: "sign in to Vi" });
  }

  get headingOops(): Locator {
    return this.page.getByRole('heading', { name: "oops!" });
  }

  get link0(): Locator {
    return this.page.locator('a[href="https://www.myvi.in/account/login#"]');
  }
  ...
  get linkNoExtraFeeOnViAppRecharges(): Locator {
    return this.page.getByRole('link', { name: "No Extra Fee on Vi App recharges!" });
  }

  get linkGetNow(): Locator {
    return this.page.getByRole('link', { name: "get now" });
  }
  ...
  get link170(): Locator {
    return this.page.locator('a[href="https://www.myvi.in/account/target=%22_blank%22"]');
  }
  ...
  get inputViMobileNumber(): Locator {
    return this.page.locator('input[name="number"]');
  }

  get inputSelfOneTimeCode(): Locator {
    return this.page.locator('input[name="self-one-time-code"]');
  }

  get inputSelfOneTimeCode1(): Locator {
    return this.page.locator('input[name="self-one-time-code"]');
  }

  get inputSelfOneTimeCode2(): Locator {
    return this.page.locator('input[name="self-one-time-code"]');
  }

  get inputSelfOneTimeCode3(): Locator {
    return this.page.locator('input[name="self-one-time-code"]');
  }

  get inputMobileerrormgs(): Locator {
    return this.page.locator('input[name="MobileErrorMgs"]');
  }
  ...
  get inputSuspendednonpayment(): Locator {
    return this.page.locator('input[name="suspendednonpayment"]');
  }

  get inputSecuritydepositerrormsg(): Locator {
    return this.page.locator('input[name="securityDepositErrorMsg"]');
  }

  get inputReverificationerrormsg(): Locator {
    return this.page.locator('input[name="reverificationErrorMsg"]');
  }

  get inputNonpaymentdisconnectionerrormsg(): Locator {
    return this.page.locator('input[name="nonPaymentDisconnectionErrorMsg"]');
  }

  get inputReactivateerrormsg(): Locator {
    return this.page.locator('input[name="reactivateErrorMsg"]');
  }

  get inputLownillusagereason1(): Locator {
    return this.page.locator('input[name="lowNillUsagereason1"]');
  }

  get inputLownillusagereason2(): Locator {
    return this.page.locator('input[name="lowNillUsagereason2"]');
  }

  get inputWrongotperrmsg(): Locator {
    return this.page.locator('input[name="wrongOtpErrMsg"]');
  }

  get inputApierrormsg(): Locator {
    return this.page.locator('input[name="apiErrorMsg"]');
  }

  get inputResendlimitexc(): Locator {
    return this.page.locator('input[name="resendLimitExc"]');
  }

  get inputVerifylimitexc(): Locator {
    return this.page.locator('input[name="verifyLimitExc"]');
  }

  get inputBothlimitexceed(): Locator {
    return this.page.locator('input[name="bothLimitExceed"]');
  }

  get inputResendmessage(): Locator {
    return this.page.locator('input[name="resendMessage"]');
  }

  get inputOtpsentmessage(): Locator {
    return this.page.locator('input[name="otpsentMessage"]');
  }

  get inputCocperrormsg(): Locator {
    return this.page.locator('input[name="cocpErrorMsg"]');
  }
