...
- Name: www-myvi-in\BuyANewVi4gSimCardOnlineAndGetAFreeDelivery.spec.ts >> https://www.myvi.in/ - Buy a New Vi 4g SIM Card Online and Get a Free Delivery - Regression Tests >> Verify that 16 Headings are present on Buy a New Vi 4g SIM Card Online and Get a Free Delivery @regression
- Location: tests\generated\www-myvi-in\BuyANewVi4gSimCardOnlineAndGetAFreeDelivery.spec.ts:50:3
...
Locator: getByRole('heading', { name: 'individual plan' }).first()
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'individual plan' }).first()
...
- paragraph: ₹451
- paragraph: per month
- paragraph: 50GB + Unlimited Night Data 12 AM to 6 AM, 200GB roll over
- paragraph: Data
- img "Vi Movies & TV"
- img "JioHotstar"
- img "Sony LIV"
...
```ts
  ...
  3   | import { BuyANewVi4gSimCardOnlineAndGetAFreeDelivery } from '../../../pages/generated/www-myvi-in/BuyANewVi4gSimCardOnlineAndGetAFreeDelivery.page';
  ...
  6   | 
  7   | test.describe("https://www.myvi.in/ - Buy a New Vi 4g SIM Card Online and Get a Free Delivery - Regression Tests", () => {
  8   |   let appPage: BuyANewVi4gSimCardOnlineAndGetAFreeDelivery;
  9   | 
  10  |   test.beforeEach(async ({ page }) => {
  11  |     appPage = new BuyANewVi4gSimCardOnlineAndGetAFreeDelivery(page);
  12  |     await appPage.open();
  13  |   });
  14  | 
  15  |   test("Verify that Buy a New Vi 4g SIM Card Online and Get a Free Delivery loads successfully @regression", async ({ page }, testInfo) => {
