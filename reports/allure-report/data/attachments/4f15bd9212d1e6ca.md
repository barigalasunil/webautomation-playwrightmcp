...
- Name: www-myvi-in\Vi5gNetworkInIndiaExplorePlansSimCoverageMapViIndia.spec.ts >> https://www.myvi.in/ - Vi 5G Network in India – Explore Plans, SIM & Coverage Map | Vi India - Regression Tests >> Verify that 2 Menus are present on Vi 5G Network in India – Explore Plans, SIM & Coverage Map | Vi India @regression
- Location: tests\generated\www-myvi-in\Vi5gNetworkInIndiaExplorePlansSimCoverageMapViIndia.spec.ts:188:3
...
- img "image2"
- img "Vi logo"
- paragraph: made for new experiences
- paragraph: Transport yourself in immersive VR/AR and 360° experiences. Experience events and places like never before.
- img "image3"
...
> 207 |       await expect(appPage.menuPrepaidpostpaidnewConnectioninternationalRoaming5gottsMor.first()).toBeAttached({ timeout: 5000 });
  ...
  216 |       const screenshotPath = await captureTestScreenshot(page, testInfo, "Vi 5G Network in India – Explore Plans, SIM & Coverage Map | Vi India - Menu Verification", "www.myvi.in");
