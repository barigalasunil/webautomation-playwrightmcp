...
- Name: www-myvi-in\GetANewViPrepaidSimCardIn3SimpleStepsBuyNewSim.spec.ts >> https://www.myvi.in/ - Get a New Vi Prepaid SIM Card in 3 Simple Steps - Buy New Sim - Regression Tests >> Verify that 2 Menus are present on Get a New Vi Prepaid SIM Card in 3 Simple Steps - Buy New Sim @regression
- Location: tests\generated\www-myvi-in\GetANewViPrepaidSimCardIn3SimpleStepsBuyNewSim.spec.ts:234:3
...
Locator: getByRole('navigation', { name: 'home new connection prepaid connection' }).first()
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('navigation', { name: 'home new connection prepaid connection' }).first()
...
- toolbar:
  - listbox:
    - option "98XXXXXX98 or a similar fancy number can be yours Choose your own special number with a new Vi connection I want a special number >>":
      - heading "98XXXXXX98 or a similar fancy number can be yours" [level=2]
      - paragraph: Choose your own special number with a new Vi connection
      - paragraph: I want a special number
      - text: ">>"
      - img
  - tablist:
    - listitem:
...
> 257 |       await expect(appPage.menuHomeNewConnectionPrepaidConnection.first()).toBeAttached({ timeout: 5000 });
  ...
  262 |       const screenshotPath = await captureTestScreenshot(page, testInfo, "Get a New Vi Prepaid SIM Card in 3 Simple Steps - Buy New Sim - Menu Verification", "www.myvi.in");
