...
- Name: www-myvi-in\ViMaxFamilyPlansBestPostpaidPlanForFamilyPostpaidFamilyPlans.spec.ts >> https://www.myvi.in/ - Vi Max Family Plans | Best Postpaid Plan for Family | Postpaid Family Plans - Regression Tests >> Verify that 19 Inputs are present on Vi Max Family Plans | Best Postpaid Plan for Family | Postpaid Family Plans @regression
- Location: tests\generated\www-myvi-in\ViMaxFamilyPlansBestPostpaidPlanForFamilyPostpaidFamilyPlans.spec.ts:188:3
...
Locator: locator('input[name="pincodeField"]').first()
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('input[name="pincodeField"]').first()
...
- toolbar:
  - listbox:
    - option "your family plan your choice of benefits Only with Vi Max Postpaid view plans >>":
      - heading "your family plan your choice of benefits" [level=2]
      - paragraph: Only with Vi Max Postpaid
