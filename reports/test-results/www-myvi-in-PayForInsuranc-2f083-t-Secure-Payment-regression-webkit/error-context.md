...
- Name: www-myvi-in\PayForInsuranceOnlineWithViFastSecurePayment.spec.ts >> https://www.myvi.in/ - Pay for Insurance Online with Vi – Fast & Secure Payment - Regression Tests >> Verify that 1 Menu is present on Pay for Insurance Online with Vi – Fast & Secure Payment @regression
- Location: tests\generated\www-myvi-in\PayForInsuranceOnlineWithViFastSecurePayment.spec.ts:252:3
...
```ts
  ...
  212 |       const screenshotPath = await captureTestScreenshot(page, testInfo, "Pay for Insurance Online with Vi – Fast & Secure Payment - Input Verification", "www.myvi.in");
  213 |       evidence.screenshots.push(screenshotPath);
  214 |     });
  215 | 
  216 |     await attachExecutionSummary(evidence, page, testInfo);
  217 |   });
  218 |   test("Verify that 2 Forms are present on Pay for Insurance Online with Vi – Fast & Secure Payment @regression", async ({ page }, testInfo) => {
  219 |     await label('suite', "Regression Test Suite");
  220 |     await label('url', "https://www.myvi.in/");
  221 |     await label('domain', "www.myvi.in");
  222 |     await feature("Pay for Insurance Online with Vi – Fast & Secure Payment");
  ...
  231 |       pageName: "Pay for Insurance Online with Vi – Fast & Secure Payment",
  232 |       pageUrl: "https://www.myvi.in/utilities/pay-insurance-bill",
  ...
  246 |       const screenshotPath = await captureTestScreenshot(page, testInfo, "Pay for Insurance Online with Vi – Fast & Secure Payment - Form Verification", "www.myvi.in");
  247 |       evidence.screenshots.push(screenshotPath);
  248 |     });
  249 | 
  250 |     await attachExecutionSummary(evidence, page, testInfo);
  251 |   });
  252 |   test("Verify that 1 Menu is present on Pay for Insurance Online with Vi – Fast & Secure Payment @regression", async ({ page }, testInfo) => {
  253 |     await label('suite', "Regression Test Suite");
  254 |     await label('url', "https://www.myvi.in/");
  255 |     await label('domain', "www.myvi.in");
  256 |     await feature("Pay for Insurance Online with Vi – Fast & Secure Payment");
  ...
  265 |       pageName: "Pay for Insurance Online with Vi – Fast & Secure Payment",
  266 |       pageUrl: "https://www.myvi.in/utilities/pay-insurance-bill",
...
> 271 |       await expect(appPage.menuOpenInViAppSignInSignInDashboardMyAccountPrepaid.first()).toBeAttached({ timeout: 5000 });
  ...
  276 |       const screenshotPath = await captureTestScreenshot(page, testInfo, "Pay for Insurance Online with Vi – Fast & Secure Payment - Menu Verification", "www.myvi.in");
