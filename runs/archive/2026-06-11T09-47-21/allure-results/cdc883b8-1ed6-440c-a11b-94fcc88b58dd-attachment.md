...
- Name: www-myvi-in\CheckViSimStatusOnlineTrackYourConnectionOrders.spec.ts >> https://www.myvi.in/ - Check Vi SIM Status Online | Track Your Connection & Orders - Regression Tests >> Verify that 55 Inputs are present on Check Vi SIM Status Online | Track Your Connection & Orders @regression
- Location: tests\generated\www-myvi-in\CheckViSimStatusOnlineTrackYourConnectionOrders.spec.ts:188:3
...
Locator: locator('input[name="otpStatus"]').first()
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('input[name="otpStatus"]').first()
