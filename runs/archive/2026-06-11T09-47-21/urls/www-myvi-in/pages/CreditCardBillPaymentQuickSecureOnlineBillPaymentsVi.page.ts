...
export class CreditCardBillPaymentQuickSecureOnlineBillPaymentsVi extends BasePage {
  readonly url = "https://www.myvi.in/utilities/credit-card-bill-payment";

  // All element locators are generated dynamically using locator strategies

  get headingPayYourCreditCardBillInSeconds(): Locator {
    return this.page.getByRole('heading', { name: "pay your credit card bill in seconds" });
  }

  get link0(): Locator {
    return this.page.locator('a[href="https://www.myvi.in/utilities/credit-card-bill-payment#"]');
  }
  ...
  get inputSearchByBiller(): Locator {
    return this.page.getByPlaceholder("search by biller");
  }
