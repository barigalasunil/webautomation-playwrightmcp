...
export class OnlineMobileRechargeBestPrepaidPlansTopUpsViIndia extends BasePage {
  readonly url = "https://www.myvi.in/prepaid/online-mobile-recharge";

  // All element locators are generated dynamically using locator strategies

  get headingOnlineMobileRecharge(): Locator {
    return this.page.getByRole('heading', { name: "online mobile recharge" });
  }

  get headingFaqsForViOnlineMobileRecharge(): Locator {
    return this.page.getByRole('heading', { name: "FAQs for Vi online mobile recharge" });
  }

  get headingViPrepaidOnlineRecharge(): Locator {
    return this.page.getByRole('heading', { name: "Vi Prepaid Online Recharge" });
  }

  get headingKeyFeaturesOfViOnlineMobileRecharge(): Locator {
    return this.page.getByRole('heading', { name: "Key Features of Vi Online Mobile Recharge:" });
  }

  get headingHowToRechargeOnlineWithVi(): Locator {
    return this.page.getByRole('heading', { name: "How to Recharge Online with Vi?" });
  }

  get headingBenefitsOfRechargingOnlineVsOffline(): Locator {
    return this.page.getByRole('heading', { name: "Benefits of Recharging Online vs. Offline" });
  }
  ...
  get linkOnlineMobileRecharge(): Locator {
    return this.page.getByRole('link', { name: "Online mobile recharge" });
  }
  ...
  get buttonPopularRechargePacks(): Locator {
    return this.page.getByRole('button', { name: "popular recharge packs" });
  }
  ...
  get buttonHandsetLossInsurance(): Locator {
    return this.page.getByRole('button', { name: "handset loss insurance" });
  }
  ...
  get inputSearchByPrice(): Locator {
    return this.page.getByPlaceholder("Search by price");
  }
  ...
  get menuHomeprepaidonlineMobileRecharge(): Locator {
    return this.page.getByRole('navigation', { name: "HomePrepaidOnline mobile recharge" });
  }
