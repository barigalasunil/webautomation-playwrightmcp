...
export class PayForInsuranceOnlineWithViFastSecurePayment extends BasePage {
  readonly url = "https://www.myvi.in/utilities/pay-insurance-bill";

  // All element locators are generated dynamically using locator strategies

  get headingPayYourInsuranceBillInSeconds(): Locator {
    return this.page.getByRole('heading', { name: "pay your insurance bill in seconds" });
  }

  get link0(): Locator {
    return this.page.locator('a[href="https://www.myvi.in/utilities/pay-insurance-bill#"]');
  }
  ...
  get buttonProceedToAddBiller(): Locator {
    return this.page.getByRole('button', { name: "proceed to add biller" });
  }
  ...
  get inputSearchYourBiller(): Locator {
    return this.page.getByPlaceholder("search your biller");
  }
