...
export class ViLoanEmiPaymentQuickSecureOnlinePayment extends BasePage {
  readonly url = "https://www.myvi.in/utilities/loan-payment";

  // All element locators are generated dynamically using locator strategies

  get headingPayYourLoanEmiInSeconds(): Locator {
    return this.page.getByRole('heading', { name: "pay your loan EMI in seconds" });
  }

  get link0(): Locator {
    return this.page.locator('a[href="https://www.myvi.in/utilities/loan-payment#"]');
  }
  ...
  get inputSearchYourLoanLender(): Locator {
    return this.page.getByPlaceholder("search your loan lender");
  }
