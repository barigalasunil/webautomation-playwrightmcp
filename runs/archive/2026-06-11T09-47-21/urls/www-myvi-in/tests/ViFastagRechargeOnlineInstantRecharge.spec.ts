...
import { ViFastagRechargeOnlineInstantRecharge } from '../../../pages/generated/www-myvi-in/ViFastagRechargeOnlineInstantRecharge.page';
...
test.describe("https://www.myvi.in/ - Vi FASTag Recharge Online | Instant Recharge - Regression Tests", () => {
  let appPage: ViFastagRechargeOnlineInstantRecharge;

  test.beforeEach(async ({ page }) => {
    appPage = new ViFastagRechargeOnlineInstantRecharge(page);
    await appPage.open();
  });

  test("Verify that Vi FASTag Recharge Online | Instant Recharge loads successfully @regression", async ({ page }, testInfo) => {
    await label('suite', "Regression Test Suite");
    await label('url', "https://www.myvi.in/");
    await label('domain', "www.myvi.in");
    await feature("Vi FASTag Recharge Online | Instant Recharge");
    ...
    const evidence = createEvidence({
      ...
      pageName: "Vi FASTag Recharge Online | Instant Recharge",
      pageUrl: "https://www.myvi.in/utilities/fastag-recharge",
    ...
    await test.step("Verify the URL is correct", async () => {
      await expect(appPage.page).toHaveURL(/https:\/\/www\.myvi\.in\/utilities\/fastag\-recharge/);
      evidence.validationsPerformed.push("Verified URL is correct");
    });

    await test.step("Capture screenshot evidence", async () => {
      const screenshotPath = await captureTestScreenshot(page, testInfo, "Vi FASTag Recharge Online | Instant Recharge - Final Evidence", "www.myvi.in");
      evidence.screenshots.push(screenshotPath);
    });

    await attachExecutionSummary(evidence, page, testInfo);
  });
  test("Verify that 1 Heading is present on Vi FASTag Recharge Online | Instant Recharge @regression", async ({ page }, testInfo) => {
    await label('suite', "Regression Test Suite");
    await label('url', "https://www.myvi.in/");
    await label('domain', "www.myvi.in");
    await feature("Vi FASTag Recharge Online | Instant Recharge");
    ...
    await test.step("Verify that the heading 'recharge your FASTag in seconds' exists in the DOM", async () => {
      await expect(appPage.headingRechargeYourFastagInSeconds.first()).toBeAttached({ timeout: 5000 });
      evidence.validationsPerformed.push("Verify that the heading 'recharge your FASTag in seconds' exists in the DOM");
    });

    await test.step("Capture screenshot evidence", async () => {
      const screenshotPath = await captureTestScreenshot(page, testInfo, "Vi FASTag Recharge Online | Instant Recharge - Heading Verification", "www.myvi.in");
      evidence.screenshots.push(screenshotPath);
    });

    await attachExecutionSummary(evidence, page, testInfo);
  });
  test("Verify that 158 Links are present on Vi FASTag Recharge Online | Instant Recharge @regression", async ({ page }, testInfo) => {
    await label('suite', "Regression Test Suite");
    await label('url', "https://www.myvi.in/");
    await label('domain', "www.myvi.in");
    await feature("Vi FASTag Recharge Online | Instant Recharge");
    ...
    await test.step("Capture screenshot evidence", async () => {
      const screenshotPath = await captureTestScreenshot(page, testInfo, "Vi FASTag Recharge Online | Instant Recharge - Link Verification", "www.myvi.in");
      evidence.screenshots.push(screenshotPath);
    });

    await attachExecutionSummary(evidence, page, testInfo);
  });
  test("Verify that 19 Buttons are present on Vi FASTag Recharge Online | Instant Recharge @regression", async ({ page }, testInfo) => {
    await label('suite', "Regression Test Suite");
    await label('url', "https://www.myvi.in/");
    await label('domain', "www.myvi.in");
    await feature("Vi FASTag Recharge Online | Instant Recharge");
    ...
    await test.step("Capture screenshot evidence", async () => {
      const screenshotPath = await captureTestScreenshot(page, testInfo, "Vi FASTag Recharge Online | Instant Recharge - Button Verification", "www.myvi.in");
      evidence.screenshots.push(screenshotPath);
    });

    await attachExecutionSummary(evidence, page, testInfo);
  });
  test("Verify that 37 Inputs are present on Vi FASTag Recharge Online | Instant Recharge @regression", async ({ page }, testInfo) => {
    await label('suite', "Regression Test Suite");
    await label('url', "https://www.myvi.in/");
    await label('domain', "www.myvi.in");
    await feature("Vi FASTag Recharge Online | Instant Recharge");
    ...
    await test.step("Capture screenshot evidence", async () => {
      const screenshotPath = await captureTestScreenshot(page, testInfo, "Vi FASTag Recharge Online | Instant Recharge - Input Verification", "www.myvi.in");
      evidence.screenshots.push(screenshotPath);
    });

    await attachExecutionSummary(evidence, page, testInfo);
  });
  test("Verify that 2 Forms are present on Vi FASTag Recharge Online | Instant Recharge @regression", async ({ page }, testInfo) => {
    await label('suite', "Regression Test Suite");
    await label('url', "https://www.myvi.in/");
    await label('domain', "www.myvi.in");
    await feature("Vi FASTag Recharge Online | Instant Recharge");
    ...
    await test.step("Capture screenshot evidence", async () => {
      const screenshotPath = await captureTestScreenshot(page, testInfo, "Vi FASTag Recharge Online | Instant Recharge - Form Verification", "www.myvi.in");
      evidence.screenshots.push(screenshotPath);
    });

    await attachExecutionSummary(evidence, page, testInfo);
  });
  test("Verify that 1 Menu is present on Vi FASTag Recharge Online | Instant Recharge @regression", async ({ page }, testInfo) => {
    await label('suite', "Regression Test Suite");
    await label('url', "https://www.myvi.in/");
    await label('domain', "www.myvi.in");
    await feature("Vi FASTag Recharge Online | Instant Recharge");
    ...
    await test.step("Capture screenshot evidence", async () => {
      const screenshotPath = await captureTestScreenshot(page, testInfo, "Vi FASTag Recharge Online | Instant Recharge - Menu Verification", "www.myvi.in");
      evidence.screenshots.push(screenshotPath);
    });
