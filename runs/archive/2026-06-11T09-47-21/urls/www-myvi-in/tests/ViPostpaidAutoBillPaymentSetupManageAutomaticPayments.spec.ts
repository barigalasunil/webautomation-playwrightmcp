...
import { ViPostpaidAutoBillPaymentSetupManageAutomaticPayments } from '../../../pages/generated/www-myvi-in/ViPostpaidAutoBillPaymentSetupManageAutomaticPayments.page';
...
test.describe("https://www.myvi.in/ - Vi Postpaid Auto Bill Payment - Setup & Manage Automatic Payments - Regression Tests", () => {
  let appPage: ViPostpaidAutoBillPaymentSetupManageAutomaticPayments;

  test.beforeEach(async ({ page }) => {
    appPage = new ViPostpaidAutoBillPaymentSetupManageAutomaticPayments(page);
    await appPage.open();
  });

  test("Verify that Vi Postpaid Auto Bill Payment - Setup & Manage Automatic Payments loads successfully @regression", async ({ page }, testInfo) => {
    await label('suite', "Regression Test Suite");
    await label('url', "https://www.myvi.in/");
    await label('domain', "www.myvi.in");
    await feature("Vi Postpaid Auto Bill Payment - Setup & Manage Automatic Payments");
    ...
    const evidence = createEvidence({
      ...
      pageName: "Vi Postpaid Auto Bill Payment - Setup & Manage Automatic Payments",
      pageUrl: "https://www.myvi.in/postpaid/auto-bill-payment",
    ...
    await test.step("Verify the URL is correct", async () => {
      await expect(appPage.page).toHaveURL(/https:\/\/www\.myvi\.in\/postpaid\/auto\-bill\-payment/);
      evidence.validationsPerformed.push("Verified URL is correct");
    });

    await test.step("Capture screenshot evidence", async () => {
      const screenshotPath = await captureTestScreenshot(page, testInfo, "Vi Postpaid Auto Bill Payment - Setup & Manage Automatic Payments - Final Evidence", "www.myvi.in");
      evidence.screenshots.push(screenshotPath);
    });

    await attachExecutionSummary(evidence, page, testInfo);
  });
  test("Verify that 17 Headings are present on Vi Postpaid Auto Bill Payment - Setup & Manage Automatic Payments @regression", async ({ page }, testInfo) => {
    await label('suite', "Regression Test Suite");
    await label('url', "https://www.myvi.in/");
    await label('domain', "www.myvi.in");
    await feature("Vi Postpaid Auto Bill Payment - Setup & Manage Automatic Payments");
    ...
    await test.step("Verify that the heading 'manage auto bill payment' exists in the DOM", async () => {
      await expect(appPage.headingManageAutoBillPayment.first()).toBeAttached({ timeout: 5000 });
      evidence.validationsPerformed.push("Verify that the heading 'manage auto bill payment' exists in the DOM");
    });
    await test.step("Verify that the heading 'setup auto pay' exists in the DOM", async () => {
      await expect(appPage.headingSetupAutoPay.first()).toBeAttached({ timeout: 5000 });
      evidence.validationsPerformed.push("Verify that the heading 'setup auto pay' exists in the DOM");
    });
    await test.step("Verify that the heading 'cancel auto pay' exists in the DOM", async () => {
      await expect(appPage.headingCancelAutoPay.first()).toBeAttached({ timeout: 5000 });
      evidence.validationsPerformed.push("Verify that the heading 'cancel auto pay' exists in the DOM");
    });
    await test.step("Verify that the heading 'modify auto pay' exists in the DOM", async () => {
      await expect(appPage.headingModifyAutoPay.first()).toBeAttached({ timeout: 5000 });
      evidence.validationsPerformed.push("Verify that the heading 'modify auto pay' exists in the DOM");
    });
    await test.step("Verify that the heading 'select payment source type' exists in the DOM", async () => {
      await expect(appPage.headingSelectPaymentSourceType.first()).toBeAttached({ timeout: 5000 });
      evidence.validationsPerformed.push("Verify that the heading 'select payment source type' exists in the DOM");
    });

    await test.step("Capture screenshot evidence", async () => {
      const screenshotPath = await captureTestScreenshot(page, testInfo, "Vi Postpaid Auto Bill Payment - Setup & Manage Automatic Payments - Heading Verification", "www.myvi.in");
      evidence.screenshots.push(screenshotPath);
    });

    await attachExecutionSummary(evidence, page, testInfo);
  });
  test("Verify that 163 Links are present on Vi Postpaid Auto Bill Payment - Setup & Manage Automatic Payments @regression", async ({ page }, testInfo) => {
    await label('suite', "Regression Test Suite");
    await label('url', "https://www.myvi.in/");
    await label('domain', "www.myvi.in");
    await feature("Vi Postpaid Auto Bill Payment - Setup & Manage Automatic Payments");
    ...
    await test.step("Capture screenshot evidence", async () => {
      const screenshotPath = await captureTestScreenshot(page, testInfo, "Vi Postpaid Auto Bill Payment - Setup & Manage Automatic Payments - Link Verification", "www.myvi.in");
      evidence.screenshots.push(screenshotPath);
    });

    await attachExecutionSummary(evidence, page, testInfo);
  });
  test("Verify that 23 Buttons are present on Vi Postpaid Auto Bill Payment - Setup & Manage Automatic Payments @regression", async ({ page }, testInfo) => {
    await label('suite', "Regression Test Suite");
    await label('url', "https://www.myvi.in/");
    await label('domain', "www.myvi.in");
    await feature("Vi Postpaid Auto Bill Payment - Setup & Manage Automatic Payments");
    ...
    await test.step("Capture screenshot evidence", async () => {
      const screenshotPath = await captureTestScreenshot(page, testInfo, "Vi Postpaid Auto Bill Payment - Setup & Manage Automatic Payments - Button Verification", "www.myvi.in");
      evidence.screenshots.push(screenshotPath);
    });

    await attachExecutionSummary(evidence, page, testInfo);
  });
  test("Verify that 106 Inputs are present on Vi Postpaid Auto Bill Payment - Setup & Manage Automatic Payments @regression", async ({ page }, testInfo) => {
    await label('suite', "Regression Test Suite");
    await label('url', "https://www.myvi.in/");
    await label('domain', "www.myvi.in");
    await feature("Vi Postpaid Auto Bill Payment - Setup & Manage Automatic Payments");
    ...
    await test.step("Capture screenshot evidence", async () => {
      const screenshotPath = await captureTestScreenshot(page, testInfo, "Vi Postpaid Auto Bill Payment - Setup & Manage Automatic Payments - Input Verification", "www.myvi.in");
      evidence.screenshots.push(screenshotPath);
    });

    await attachExecutionSummary(evidence, page, testInfo);
  });
  test("Verify that 2 Forms are present on Vi Postpaid Auto Bill Payment - Setup & Manage Automatic Payments @regression", async ({ page }, testInfo) => {
    await label('suite', "Regression Test Suite");
    await label('url', "https://www.myvi.in/");
    await label('domain', "www.myvi.in");
    await feature("Vi Postpaid Auto Bill Payment - Setup & Manage Automatic Payments");
    ...
    await test.step("Capture screenshot evidence", async () => {
      const screenshotPath = await captureTestScreenshot(page, testInfo, "Vi Postpaid Auto Bill Payment - Setup & Manage Automatic Payments - Form Verification", "www.myvi.in");
      evidence.screenshots.push(screenshotPath);
    });

    await attachExecutionSummary(evidence, page, testInfo);
  });
  test("Verify that 2 Menus are present on Vi Postpaid Auto Bill Payment - Setup & Manage Automatic Payments @regression", async ({ page }, testInfo) => {
    await label('suite', "Regression Test Suite");
    await label('url', "https://www.myvi.in/");
    await label('domain', "www.myvi.in");
    await feature("Vi Postpaid Auto Bill Payment - Setup & Manage Automatic Payments");
    ...
    await test.step("Verify that the menu 'Home bill autopay mandate setup' exists in the DOM", async () => {
      await expect(appPage.menuHomeBillAutopayMandateSetup.first()).toBeAttached({ timeout: 5000 });
      evidence.validationsPerformed.push("Verify that the menu 'Home bill autopay mandate setup' exists in the DOM");
    });

    await test.step("Capture screenshot evidence", async () => {
      const screenshotPath = await captureTestScreenshot(page, testInfo, "Vi Postpaid Auto Bill Payment - Setup & Manage Automatic Payments - Menu Verification", "www.myvi.in");
      evidence.screenshots.push(screenshotPath);
    });
