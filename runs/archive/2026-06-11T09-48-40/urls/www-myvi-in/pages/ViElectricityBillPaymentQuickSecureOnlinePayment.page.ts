...
export class ViElectricityBillPaymentQuickSecureOnlinePayment extends BasePage {
  readonly url = "https://www.myvi.in/utilities/electricity-bill-payment";

  // All element locators are generated dynamically using locator strategies

  get headingPayYourElectricityBillInSeconds(): Locator {
    return this.page.getByRole('heading', { name: "pay your electricity bill in seconds" });
  }

  get link0(): Locator {
    return this.page.locator('a[href="https://www.myvi.in/utilities/electricity-bill-payment#"]');
  }
  ...
  get buttonProceedToAddBillDetails(): Locator {
    return this.page.getByRole('button', { name: "proceed to add bill details" });
  }

  get buttonFetchBill(): Locator {
    return this.page.getByRole('button', { name: "fetch bill" });
  }

  get buttonProceedToPay(): Locator {
    return this.page.getByRole('button', { name: "proceed to pay" });
  }

  get buttonPay22990(): Locator {
    return this.page.getByRole('button', { name: "pay ₹ 2299.0" });
  }
  ...
  get inputUtilitynliheading(): Locator {
    return this.page.locator('input[name="utilityNLIheading"]');
  }

  get inputUtilitylandingpageurl(): Locator {
    return this.page.locator('input[name="utilityLandingPageUrl"]');
  }
  ...
  get inputCocperror(): Locator {
    return this.page.locator('input[name="cocpError"]');
  }

  get inputSearchYourElectricityProvider(): Locator {
    return this.page.getByPlaceholder("search your electricity provider");
  }

  get inputCategory(): Locator {
    return this.page.locator('input[name="category"]');
  }

  get inputBillerimgnli(): Locator {
    return this.page.locator('input[name="billerImgNLI"]');
  }

  get inputBillericonmappingnli(): Locator {
    return this.page.locator('input[name="billerIconMappingNLI"]');
  }

  get inputCategorynli(): Locator {
    return this.page.locator('input[name="categoryNLI"]');
  }
  ...
  get inputSameAsEnteredBefore(): Locator {
    return this.page.locator('input[name="enteredBefore"]');
  }
  ...
  get inputBilldetailsmapping(): Locator {
    return this.page.locator('input[name="billDetailsMapping"]');
  }

  get inputMaximumamounterror(): Locator {
    return this.page.locator('input[name="maximumAmountError"]');
  }

  get inputMinimumamounterror(): Locator {
    return this.page.locator('input[name="minimumAmountError"]');
  }

  get inputFastagbalancekeys(): Locator {
    return this.page.locator('input[name="fastagBalanceKeys"]');
  }
