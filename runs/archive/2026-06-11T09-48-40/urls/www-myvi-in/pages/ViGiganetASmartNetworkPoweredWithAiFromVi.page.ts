...
export class ViGiganetASmartNetworkPoweredWithAiFromVi extends BasePage {
  readonly url = "https://www.myvi.in/giganet";

  // All element locators are generated dynamically using locator strategies

  get headingViPoweredByGiganet(): Locator {
    return this.page.getByRole('heading', { name: "Vi powered by GIGAnet" });
  }

  get headingGiganetFaqs(): Locator {
    return this.page.getByRole('heading', { name: "GIGAnet FAQs" });
  }

  get headingDownloadViApp(): Locator {
    return this.page.getByRole('heading', { name: "Download Vi app" });
  }
  ...
  get linkBuyPrepaidNow(): Locator {
    return this.page.getByRole('link', { name: "buy prepaid now" });
  }
  ...
  get linkTermsAndConditions(): Locator {
