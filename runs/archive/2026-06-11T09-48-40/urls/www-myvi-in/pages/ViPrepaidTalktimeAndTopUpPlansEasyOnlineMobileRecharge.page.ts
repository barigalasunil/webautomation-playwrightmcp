...
export class ViPrepaidTalktimeAndTopUpPlansEasyOnlineMobileRecharge extends BasePage {
  readonly url = "https://www.myvi.in/prepaid/recharge-talktime-top-up-plans";

  // All element locators are generated dynamically using locator strategies

  get headingTopUpVoucher(): Locator {
    return this.page.getByRole('heading', { name: "Top Up Voucher" });
  }

  get headingTopUpVoucher1(): Locator {
    return this.page.getByRole('heading', { name: "top up voucher" });
  }
  ...
  get headingTalkTimeTopUpPlans(): Locator {
    return this.page.getByRole('heading', { name: "Talk time top up plans" });
  }
  ...
  get linkTalktimeOrTopUpPlans(): Locator {
    return this.page.getByRole('link', { name: "Talktime or Top Up Plans" });
  }
  ...
  get linkPrepaidRechargePlan(): Locator {
    return this.page.getByRole('link', { name: "prepaid recharge plan" });
  }

  get linkServiceValidityRecharge(): Locator {
    return this.page.getByRole('link', { name: "service validity recharge" });
  }

  get linkTopUpPlans(): Locator {
    return this.page.getByRole('link', { name: "top-up plans" });
  }
  ...
  get menuHomeprepaidtalktimeOrTopUpPlans(): Locator {
    return this.page.getByRole('navigation', { name: "HomeprepaidTalktime or Top Up Plans" });
  }
