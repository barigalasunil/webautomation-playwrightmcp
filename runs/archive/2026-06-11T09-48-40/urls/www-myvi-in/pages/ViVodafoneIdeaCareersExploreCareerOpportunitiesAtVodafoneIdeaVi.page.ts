...
export class ViVodafoneIdeaCareersExploreCareerOpportunitiesAtVodafoneIdeaVi extends BasePage {
  readonly url = "https://www.myvi.in/careers";

  // All element locators are generated dynamically using locator strategies

  get headingBeAPartOfIndiaSLeadingTelecomCompany(): Locator {
    return this.page.getByRole('heading', { name: "Be a part of India's leading telecom company" });
  }

  get headingLifeAtVil(): Locator {
    return this.page.getByRole('heading', { name: "Life at VIL" });
  }

  get headingLoveWhatYouDo(): Locator {
    return this.page.getByRole('heading', { name: "Love what you do!" });
  }

  get headingPerksOfBeingWithVil(): Locator {
    return this.page.getByRole('heading', { name: "perks of being with VIL" });
  }

  get headingAgility(): Locator {
    return this.page.getByRole('heading', { name: "Agility" });
  }

  get headingBenefits(): Locator {
    return this.page.getByRole('heading', { name: "Benefits" });
  }

  get headingOurValues(): Locator {
    return this.page.getByRole('heading', { name: "Our values" });
  }

  get headingPeopleFirst(): Locator {
    return this.page.getByRole('heading', { name: "People first" });
  }

  get headingLearningNeverStops(): Locator {
    return this.page.getByRole('heading', { name: "Learning never stops" });
  }

  get headingInnovation(): Locator {
    return this.page.getByRole('heading', { name: "Innovation" });
  }

  get headingFreedomToGrow(): Locator {
    return this.page.getByRole('heading', { name: "Freedom to grow" });
  }

  get headingLessLikelyToBeInjured(): Locator {
    return this.page.getByRole('heading', { name: "Less likely to be injured" });
  }

  get headingWorkLifeBalance(): Locator {
    return this.page.getByRole('heading', { name: "Work life balance" });
  }

  get headingOpenPositionWithUs(): Locator {
    return this.page.getByRole('heading', { name: "Open position with us" });
  }

  get headingEnterprise(): Locator {
    return this.page.getByRole('heading', { name: "Enterprise" });
  }

  get headingDigital(): Locator {
    return this.page.getByRole('heading', { name: "Digital" });
  }

  get headingRetail(): Locator {
    return this.page.getByRole('heading', { name: "Retail" });
  }

  get headingSalesDistribution(): Locator {
    return this.page.getByRole('heading', { name: "Sales & Distribution" });
  }

  get headingCommercialFinance(): Locator {
    return this.page.getByRole('heading', { name: "Commercial/ Finance" });
  }
  ...
  get link1(): Locator {
    return this.page.locator('a[href="https://careers.vodafoneidea.com/search/"]');
  }

  get linkViewJobs(): Locator {
    return this.page.getByRole('link', { name: "View Jobs" });
  }

  get linkViewJobs1(): Locator {
    return this.page.getByRole('link', { name: "View Jobs" });
  }

  get linkViewJobs2(): Locator {
    return this.page.getByRole('link', { name: "View Jobs" });
  }

  get linkViewJobs3(): Locator {
    return this.page.getByRole('link', { name: "View Jobs" });
  }

  get linkViewJobs4(): Locator {
    return this.page.getByRole('link', { name: "View Jobs" });
  }

  get linkWwwVodafoneideaComCareers(): Locator {
    return this.page.getByRole('link', { name: "www.vodafoneidea.com/careers" });
  }
  ...
  get buttonViewJobs(): Locator {
    return this.page.getByRole('button', { name: "View Jobs" });
  }

  get buttonViewJobs1(): Locator {
    return this.page.getByRole('button', { name: "View Jobs" });
  }

  get buttonViewJobs2(): Locator {
    return this.page.getByRole('button', { name: "View Jobs" });
  }

  get buttonViewJobs3(): Locator {
    return this.page.getByRole('button', { name: "View Jobs" });
  }

  get buttonViewJobs4(): Locator {
    return this.page.getByRole('button', { name: "View Jobs" });
  }
  ...
  get menuHomecareers(): Locator {
    return this.page.getByRole('navigation', { name: "HomeCareers" });
  }
