...
export class ViVodafoneIdeaViMaxPostpaidPrepaidViGamesMore extends BasePage {
  readonly url = "https://www.myvi.in/";

  // All element locators are generated dynamically using locator strategies

  get headingRechargePayBill(): Locator {
    return this.page.getByRole('heading', { name: "recharge / pay bill" });
  }

  get headingUtilityPayments(): Locator {
    return this.page.getByRole('heading', { name: "utility payments" });
  }

  get headingCreditCardBill(): Locator {
    return this.page.getByRole('heading', { name: "credit card bill" });
  }

  get headingElectricityPayment(): Locator {
    return this.page.getByRole('heading', { name: "electricity payment" });
  }

  get headingInsurancePremium(): Locator {
    return this.page.getByRole('heading', { name: "insurance premium" });
  }

  get headingFastag(): Locator {
    return this.page.getByRole('heading', { name: "fastag" });
  }

  get headingLoanRepayment(): Locator {
    return this.page.getByRole('heading', { name: "loan repayment" });
  }

  get headingThereSAlwaysMoreWithVi(): Locator {
    return this.page.getByRole('heading', { name: "there’s always more with Vi" });
  }

  get headingTheBestMobilePlansForYou(): Locator {
    return this.page.getByRole('heading', { name: "the best mobile plans for you" });
  }
  ...
  get headingExploreMoreServices(): Locator {
    return this.page.getByRole('heading', { name: "explore more services" });
  }

  get headingReadyToTravelTheWorld(): Locator {
    return this.page.getByRole('heading', { name: "ready to travel the world?" });
  }

  get headingExploreMore(): Locator {
    return this.page.getByRole('heading', { name: "explore more" });
  }

  get headingExploreViApp(): Locator {
    return this.page.getByRole('heading', { name: "Explore Vi app" });
  }

  get headingNeedHelpWeVeGotYouCovered(): Locator {
    return this.page.getByRole('heading', { name: "need help? we’ve got you covered!" });
  }
  ...
  get headingYourCookiePreferences(): Locator {
    return this.page.getByRole('heading', { name: "your cookie preferences" });
  }
  ...
  get headingOurOtherImportantOfferings(): Locator {
    return this.page.getByRole('heading', { name: "Our Other Important Offerings:" });
  }
  ...
  get link3(): Locator {
    return this.page.locator('a[href="https://viapp.onelink.me/bSC3/pl4"]');
  }
  ...
  get link5(): Locator {
    return this.page.locator('a[href="https://viapp.onelink.me/bSC3/we1"]');
  }
  ...
  get linkBuyPostpaidSimviewPlans(): Locator {
    return this.page.getByRole('link', { name: "buy postpaid simview plans" });
  }

  get linkInternationalRoamingexploreNow(): Locator {
    return this.page.getByRole('link', { name: "international roamingexplore now" });
  }

  get linkBuyPrepaidSimviewPacks(): Locator {
    return this.page.getByRole('link', { name: "buy prepaid simview packs" });
  }

  get linkBuyFancyNumberchooseNumber(): Locator {
    return this.page.getByRole('link', { name: "buy fancy numberchoose number" });
  }

  get linkCreditCardBill(): Locator {
    return this.page.getByRole('link', { name: "credit card bill" });
  }

  get linkElectricityPayment(): Locator {
    return this.page.getByRole('link', { name: "electricity payment" });
  }

  get linkInsurancePremium(): Locator {
    return this.page.getByRole('link', { name: "insurance premium" });
  }
  ...
  get linkExploremore(): Locator {
    return this.page.getByRole('link', { name: "exploremore" });
  }
  ...
  get link20(): Locator {
    return this.page.locator('a[href="https://www.myvi.in/prepaid/sonyliv-subscription-recharge-plans"]');
  }
  ...
  get linkPayBillForOthers(): Locator {
    return this.page.getByRole('link', { name: "pay bill for others" });
  }

  get linkRechargeForOthers(): Locator {
    return this.page.getByRole('link', { name: "recharge for others" });
  }

  get linkOttPacks(): Locator {
    return this.page.getByRole('link', { name: "OTT packs" });
  }

  get linkUpgradeToPostpaid(): Locator {
    return this.page.getByRole('link', { name: "upgrade to postpaid" });
  }

  get linkGetNewConnection(): Locator {
    return this.page.getByRole('link', { name: "get new connection" });
  }
  ...
  get linkSwitchToEsim(): Locator {
    return this.page.getByRole('link', { name: "switch to eSIM" });
  }
  ...
  get linkSetupAutopay(): Locator {
    return this.page.getByRole('link', { name: "setup autopay" });
  }

  get linkFullPostOnX(): Locator {
    return this.page.getByRole('link', { name: "full post on X" });
  }

  get linkFullPostOnX1(): Locator {
    return this.page.getByRole('link', { name: "full post on X" });
  }

  get linkFullPostOnX2(): Locator {
    return this.page.getByRole('link', { name: "full post on X" });
  }

  get linkFullPostOnX3(): Locator {
    return this.page.getByRole('link', { name: "full post on X" });
  }

  get linkFullPostOnX4(): Locator {
    return this.page.getByRole('link', { name: "full post on X" });
  }

  get linkFullPostOnX5(): Locator {
    return this.page.getByRole('link', { name: "full post on X" });
  }

  get linkFullPostOnX6(): Locator {
    return this.page.getByRole('link', { name: "full post on X" });
  }

  get linkFullPostOnX7(): Locator {
    return this.page.getByRole('link', { name: "full post on X" });
  }

  get linkFullPostOnX8(): Locator {
    return this.page.getByRole('link', { name: "full post on X" });
  }
  ...
  get linkCallUs(): Locator {
    return this.page.getByRole('link', { name: "call us" });
  }

  get linkChatWithUs(): Locator {
    return this.page.getByRole('link', { name: "chat with us" });
  }

  get linkSolveQueriesWithVideos(): Locator {
    return this.page.getByRole('link', { name: "solve queries with videos" });
  }
  ...
  get linkMobileRecharge(): Locator {
    return this.page.getByRole('link', { name: "mobile recharge" });
  }

  get linkCashbackOffers1(): Locator {
    return this.page.getByRole('link', { name: "Cashback Offers" });
  }

  get linkPayPostpaidBillsOnline(): Locator {
    return this.page.getByRole('link', { name: "pay postpaid bills online." });
  }
  ...
  get linkPlayGamesOnline(): Locator {
    return this.page.getByRole('link', { name: "Play games online" });
  }

  get linkHttpsWwwMyviIn5gNetwork(): Locator {
    return this.page.getByRole('link', { name: "https://www.myvi.in/5g-network" });
  }

  get buttonPrepaidPacks(): Locator {
    return this.page.getByRole('button', { name: "prepaid packs" });
  }

  get buttonIndividual(): Locator {
    return this.page.getByRole('button', { name: "individual" });
  }

  get buttonFamily(): Locator {
    return this.page.getByRole('button', { name: "family" });
  }
  ...
  get inputEnterPrepaidPostpaidNumber(): Locator {
    return this.page.getByPlaceholder("enter prepaid/postpaid number");
  }
