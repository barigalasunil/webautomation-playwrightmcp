...
export class BestViSmsPacksAndSmsPlansForPrepaidRechargeViIndia extends BasePage {
  readonly url = "https://www.myvi.in/prepaid/sms-packs";

  // All element locators are generated dynamically using locator strategies

  get headingViSmsRechargePacks(): Locator {
    return this.page.getByRole('heading', { name: "Vi SMS Recharge Packs" });
  }

  get headingSmsPackRechargeFaqs(): Locator {
    return this.page.getByRole('heading', { name: "SMS Pack Recharge FAQs" });
  }

  get headingSmsRechargePacks(): Locator {
    return this.page.getByRole('heading', { name: "SMS Recharge Packs" });
  }
  ...
  get linkTrulyUnlimitedCalls(): Locator {
    return this.page.getByRole('link', { name: "truly unlimited calls" });
  }
  ...
  get menuHomeprepaidsmsPacks(): Locator {
    return this.page.getByRole('navigation', { name: "HomeprepaidSMS Packs" });
  }
