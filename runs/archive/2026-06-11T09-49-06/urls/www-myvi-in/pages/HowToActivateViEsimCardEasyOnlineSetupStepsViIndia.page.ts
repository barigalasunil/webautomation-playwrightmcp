...
export class HowToActivateViEsimCardEasyOnlineSetupStepsViIndia extends BasePage {
  readonly url = "https://www.myvi.in/esim-activation";

  // All element locators are generated dynamically using locator strategies

  get headingHowToGetStarted(): Locator {
    return this.page.getByRole('heading', { name: "how to get started?" });
  }

  get headingWhatIsViEsim(): Locator {
    return this.page.getByRole('heading', { name: "what is Vi eSIM?" });
  }
  ...
  get headingWhatIsEsim(): Locator {
    return this.page.getByRole('heading', { name: "what is eSIM?" });
  }

  get headingWhatDoesItMeanWhenADeviceHasADualSimWithAnEsim(): Locator {
    return this.page.getByRole('heading', { name: "what does it mean when a device has a dual SIM with an eSIM?" });
  }

  get headingWillTheCustomerBeRequiredToTakeAnySpecificPlanFor(): Locator {
    return this.page.getByRole('heading', { name: "will the customer be required to take any specific plan for eSIM?" });
  }

  get headingWhatAreTheBenefitsIfIMoveToEsim(): Locator {
    return this.page.getByRole('heading', { name: "what are the benefits if I move to eSIM?" });
  }

  get headingWhichAreTheEligibleDevicesOnEsim(): Locator {
    return this.page.getByRole('heading', { name: "which are the eligible devices on eSIM?" });
  }

  get headingHowCanANewViPostpaidPrepaidCustomerNewActivationGe(): Locator {
    return this.page.getByRole('heading', { name: "how can a new Vi postpaid/prepaid customer (new activation) get eSIM?" });
  }

  get headingCanIActivateMyEsimByCallingTheCustomerCareSupport(): Locator {
    return this.page.getByRole('heading', { name: "can I activate my eSIM by calling the customer care support?" });
  }

  get headingHowMuchTimeDoesItTakeToActivateEsim(): Locator {
    return this.page.getByRole('heading', { name: "How much time does it take to activate eSIM?" });
  }

  get headingDoINeedToSubmitAnyDocumentsForEsim(): Locator {
    return this.page.getByRole('heading', { name: "do I need to submit any documents for eSIM?" });
  }

  get headingWillEsimOnMyPhoneWorkOnInternationalRoaming(): Locator {
    return this.page.getByRole('heading', { name: "will eSIM on my phone work on International Roaming?" });
  }

  get headingIsItAvailableWithAllTariffPlans(): Locator {
    return this.page.getByRole('heading', { name: "is it available with all tariff plans?" });
  }

  get headingCanIGetAnEsimForMyCompanyPaidViMobilePostpaidNum(): Locator {
    return this.page.getByRole('heading', { name: "can I get an eSIM for my Company paid Vi mobile postpaid number?" });
  }

  get headingCanIUseViSPrepaidServiceOnMyDeviceWithEsimTechno(): Locator {
    return this.page.getByRole('heading', { name: "can I use Vi's prepaid service on my device with eSIM technology?" });
  }

  get headingAreThereAnyAdditionalChargesApplicableOnEsim(): Locator {
    return this.page.getByRole('heading', { name: "are there any additional charges applicable on eSIM?" });
  }

  get headingWhatHappensIfIChangeMyPhone(): Locator {
    return this.page.getByRole('heading', { name: "what happens if I change my phone?" });
  }

  get headingWhatHappensToTheEsimIfIChangeTheOperatorService(): Locator {
    return this.page.getByRole('heading', { name: "what happens to the eSIM if I change the operator service?" });
  }

  get headingHowManySimProfilesCanBeSupportedAtATime(): Locator {
    return this.page.getByRole('heading', { name: "how many SIM profiles can be supported at a time?" });
  }

  get headingIAmUnableToReceiveQrCodeAndHaveAYahooHotmailDoma(): Locator {
    return this.page.getByRole('heading', { name: "I am unable to receive QR code and have a Yahoo/Hotmail domain email ID." });
  }

  get headingHowToTransferEsimFromOnePhoneToAnother(): Locator {
    return this.page.getByRole('heading', { name: "How to transfer eSIM from one phone to another?" });
  }

  get headingIAmUnableToChangeTheEmailIdOnMySecondaryNumber(): Locator {
    return this.page.getByRole('heading', { name: "I am unable to change the email id on my secondary number" });
  }

  get headingImportantPointsWhileActivationEsimOnInternationalRoam(): Locator {
    return this.page.getByRole('heading', { name: "Important points while activation eSIM on International Roaming" });
  }

  get headingWhatAreTheStepsToConfigureEsimOnVariousHandsets(): Locator {
    return this.page.getByRole('heading', { name: "What are the steps to configure eSIM on various handsets?" });
  }

  get headingFaqsOnAppleWatchEsim(): Locator {
    return this.page.getByRole('heading', { name: "FAQs on Apple Watch eSIM" });
  }

  get headingWhatDoINeedToUseWirelessServiceOnMyAppleWatchGps(): Locator {
    return this.page.getByRole('heading', { name: "what do I need to use wireless service on my Apple Watch (GPS + Cellular)?" });
  }

  get headingIsThePairingOfAppleWatchGpsCellularAvailableWithAn(): Locator {
    return this.page.getByRole('heading', { name: "is the pairing of Apple Watch (GPS + Cellular) available with any Vi mobile post" });
  }

  get headingDoINecessarilyNeedToPairMyAppleWatchGpsCellularWi(): Locator {
    return this.page.getByRole('heading', { name: "do I necessarily need to pair my Apple Watch (GPS + Cellular) with my iPhone to" });
  }

  get headingWillIHaveANewNumberForMyAppleWatchGpsCellular(): Locator {
    return this.page.getByRole('heading', { name: "will I have a new number for my Apple Watch (GPS + Cellular)?" });
  }

  get headingWillINeedToFillUpSeparateCafForAppleWatchGpsCell(): Locator {
    return this.page.getByRole('heading', { name: "will I need to fill up separate CAF for Apple Watch (GPS + Cellular)?" });
  }

  get headingDoesAppleWatchGpsCellularRequireASpecificPlanWhatA(): Locator {
    return this.page.getByRole('heading', { name: "does Apple Watch (GPS + Cellular) require a specific plan? What are the charges?" });
  }

  get headingWillIGetASeparateBillForAppleWatchGpsCellular(): Locator {
    return this.page.getByRole('heading', { name: "will I get a separate bill for Apple Watch (GPS + Cellular)?" });
  }

  get headingCanIUseAppleWatchGpsCellularCellularInNationalRoam(): Locator {
    return this.page.getByRole('heading', { name: "can I use Apple Watch (GPS + Cellular) Cellular in National roaming?" });
  }

  get headingCanIUseAppleWatchGpsCellularInInternationalRoaming(): Locator {
    return this.page.getByRole('heading', { name: "can I use Apple Watch (GPS + Cellular) in International roaming?" });
  }

  get headingCanIUseMoreThanOneAppleWatchGpsCellularOnMyExist(): Locator {
    return this.page.getByRole('heading', { name: "can I use more than one Apple Watch (GPS + Cellular) on my existing Vi mobile po" });
  }

  get headingCanIUseAppleWatchGpsCellularOnMoreThanOneNumber(): Locator {
    return this.page.getByRole('heading', { name: "can I use Apple Watch (GPS + Cellular) on more than one number?" });
  }

  get headingHowCanIActivateANewAppleWatchGpsCellularWithMyVi(): Locator {
    return this.page.getByRole('heading', { name: "how can I activate a new Apple Watch (GPS + Cellular) with my Vi mobile postpaid" });
  }

  get headingCanIConnectMyAppleWatchGpsCellularToMyCompanyPaid(): Locator {
    return this.page.getByRole('heading', { name: "can I connect my Apple Watch (GPS + Cellular) to my Company paid Vi mobile postp" });
  }

  get headingWhatIsAnEsim(): Locator {
    return this.page.getByRole('heading', { name: "what is an eSIM?" });
  }

  get headingWhatAreTheBenefitsOfTheAppleWatchGpsCellularWithE(): Locator {
    return this.page.getByRole('heading', { name: "what are the benefits of the Apple Watch (GPS + Cellular) with eSIM?" });
  }

  get headingWillIBeChargedExtraForCallsDataUsedOnMyAppleWatc(): Locator {
    return this.page.getByRole('heading', { name: "will I be charged extra for calls/data used on my Apple Watch (GPS + Cellular)?" });
  }

  get headingDoesAppleWatchGpsCellularNeedToBeInProximityWithP(): Locator {
    return this.page.getByRole('heading', { name: "does Apple Watch (GPS + Cellular) need to be in proximity with primary iPhone de" });
  }

  get headingHowDoIKnowIfIAmConnectedToCellularOnMyAppleWatc(): Locator {
    return this.page.getByRole('heading', { name: "how do I know if I am connected to Cellular on my Apple Watch (GPS + Cellular)?" });
  }

  get headingWhatHappensIfIChangeMyPhone1(): Locator {
    return this.page.getByRole('heading', { name: "what happens if I change my phone?" });
  }

  get headingWhatHappensIfILoseMyAppleWatchGpsCellular(): Locator {
    return this.page.getByRole('heading', { name: "what happens if I lose my Apple Watch (GPS + Cellular)?" });
  }

  get headingWhatAreTheChargesForDeactivatingOrUnPairingTheAppl(): Locator {
    return this.page.getByRole('heading', { name: "what are the charges for deactivating or un-pairing the Apple Watch from Mobile" });
  }

  get headingWhichModelsOfAppleWatchGpsCellularDoesViSupport(): Locator {
    return this.page.getByRole('heading', { name: "which models of Apple Watch (GPS + Cellular) does Vi support?" });
  }

  get headingIHaveAnIdeaPostpaidConnectionWhatShouldIDoToBeEl(): Locator {
    return this.page.getByRole('heading', { name: "i have an Idea Postpaid connection, what should I do to be eligible for cellular" });
  }

  get headingWhatHappensToMyAppleWatchIfMyPostpaidNumberIsBarr(): Locator {
    return this.page.getByRole('heading', { name: "what happens to my Apple Watch if my Postpaid number is barred in case of non-pa" });
  }

  get headingWhatHappensToMyAppleWatchInCaseOfStolenLostIphone(): Locator {
    return this.page.getByRole('heading', { name: "what happens to my Apple Watch in case of stolen/lost iPhone?" });
  }

  get headingIHaveUnpairedMyLostStolenAppleWatchWillTheService(): Locator {
    return this.page.getByRole('heading', { name: "i have unpaired my Lost/Stolen Apple Watch. Will the service on the watch get de" });
  }

  get headingCanIUseMyAppleWatchGpsCellularIfMyPhoneIsSwitche(): Locator {
    return this.page.getByRole('heading', { name: "can I use my Apple Watch (GPS+Cellular) if my phone is switched off?" });
  }

  get link0(): Locator {
    return this.page.locator('a[href="https://www.myvi.in/esim-activation#"]');
  }
  ...
  get linkMyemailExampleCom(): Locator {
    return this.page.getByRole('link', { name: "myemail@example.com" });
  }

  get linkEsimVodafoneideaCom(): Locator {
    return this.page.getByRole('link', { name: "esim@vodafoneidea.com" });
  }
  ...
  get linkEsimVodafoneideaCom1(): Locator {
    return this.page.getByRole('link', { name: "esim@vodafoneidea.com" });
  }
  ...
  get linkInternationalRoamingPack(): Locator {
    return this.page.getByRole('link', { name: "International Roaming pack" });
  }
  ...
  get linkSimCard(): Locator {
    return this.page.getByRole('link', { name: "SIM card" });
  }

  get linkWwwAppleComInWatch(): Locator {
    return this.page.getByRole('link', { name: "www.apple.com/in/watch" });
  }

  get linkWwwAppleComInSupportWatch(): Locator {
    return this.page.getByRole('link', { name: "www.apple.com/in/support/watch" });
  }
  ...
  get linkInternationalRoaming2(): Locator {
    return this.page.getByRole('link', { name: "International Roaming" });
  }
  ...
  get button5(): Locator {
    return this.page.getByRole('button', { name: "5" });
  }

  get button6(): Locator {
    return this.page.getByRole('button', { name: "6" });
  }

  get buttonHowToGetStarted(): Locator {
    return this.page.getByRole('button', { name: "How to get started?" });
  }

  get buttonRequestEsimViaViApp(): Locator {
    return this.page.getByRole('button', { name: "request eSIM via Vi app" });
  }
  ...
  get inputRadioGroup(): Locator {
    return this.page.locator('input[name="radio-group"]');
  }

  get inputRadioGroup1(): Locator {
    return this.page.locator('input[name="radio-group"]');
  }
