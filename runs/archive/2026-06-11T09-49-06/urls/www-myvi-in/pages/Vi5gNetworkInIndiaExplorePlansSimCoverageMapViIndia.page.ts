...
export class Vi5gNetworkInIndiaExplorePlansSimCoverageMapViIndia extends BasePage {
  readonly url = "https://www.myvi.in/5g-network";

  // All element locators are generated dynamically using locator strategies

  get headingExperienceTheVi5gWayOfLife(): Locator {
    return this.page.getByRole('heading', { name: "experience the Vi 5G way of life" });
  }

  get headingThinkFutureThinkVi5g(): Locator {
    return this.page.getByRole('heading', { name: "think future, think Vi 5G" });
  }

  get headingExploreVi5gPacks(): Locator {
    return this.page.getByRole('heading', { name: "explore Vi 5G packs" });
  }

  get headingCheck5gCoverageCompatibility(): Locator {
    return this.page.getByRole('heading', { name: "check 5G coverage & compatibility" });
  }

  get headingVi5gFaqs(): Locator {
    return this.page.getByRole('heading', { name: "Vi 5G FAQs" });
  }
  ...
  get buttonGetANewConnection(): Locator {
    return this.page.getByRole('button', { name: "get a new connection" });
  }

  get buttonPortToVi(): Locator {
    return this.page.getByRole('button', { name: "port to Vi" });
  }
  ...
  get buttonSelectCircle(): Locator {
    return this.page.getByRole('button', { name: "select circle" });
  }

  get buttonCheckCoverage(): Locator {
    return this.page.getByRole('button', { name: "check coverage" });
  }

  get buttonSelectDevice(): Locator {
    return this.page.getByRole('button', { name: "select device" });
  }

  get buttonCheckCompatibility(): Locator {
    return this.page.getByRole('button', { name: "check compatibility" });
  }

  get button5gAndVi5g(): Locator {
    return this.page.getByRole('button', { name: "5G and Vi 5G−" });
  }

  get buttonConsumerHowToInquiries(): Locator {
    return this.page.getByRole('button', { name: "Consumer How To/Inquiries+" });
  }
