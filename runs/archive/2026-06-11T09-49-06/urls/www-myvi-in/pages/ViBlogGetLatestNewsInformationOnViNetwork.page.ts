...
export class ViBlogGetLatestNewsInformationOnViNetwork extends BasePage {
  readonly url = "https://www.myvi.in/blog";

  // All element locators are generated dynamically using locator strategies

  get headingTheblogs(): Locator {
    return this.page.getByRole('heading', { name: "theblogs" });
  }
  ...
  get link1(): Locator {
    return this.page.getByRole('link', { name: "1" });
  }
  ...
  get link3(): Locator {
    return this.page.getByRole('link', { name: "3" });
  }

  get link4(): Locator {
    return this.page.getByRole('link', { name: "4" });
  }

  get link190(): Locator {
    return this.page.getByRole('link', { name: "190" });
  }

  get link191(): Locator {
    return this.page.getByRole('link', { name: "191" });
  }

  get link192(): Locator {
    return this.page.getByRole('link', { name: "192" });
  }

  get linkNext(): Locator {
    return this.page.getByRole('link', { name: "Next" });
  }

  get linkKnowYourSim(): Locator {
    return this.page.getByRole('link', { name: "know your SIM" });
  }

  get linkKnowYourPlans(): Locator {
    return this.page.getByRole('link', { name: "know your plans" });
  }

  get linkPayYourBills(): Locator {
    return this.page.getByRole('link', { name: "pay your bills" });
  }
  ...
  get linkQuickBytes(): Locator {
    return this.page.getByRole('link', { name: "quick bytes" });
  }

  get linkWhatSNew(): Locator {
    return this.page.getByRole('link', { name: "what’s new?" });
  }

  get linkSports(): Locator {
    return this.page.getByRole('link', { name: "sports" });
  }

  get linkGetANewSim(): Locator {
    return this.page.getByRole('link', { name: "get a new SIM" });
  }
  ...
  get link120(): Locator {
    return this.page.locator('a[href="https://www.myvi.in/target=%22_blank%22"]');
  }
  ...
  get inputSearchForTopics(): Locator {
    return this.page.getByPlaceholder("search for topics");
  }
  ...
  get menuHomeblog(): Locator {
    return this.page.getByRole('navigation', { name: "HomeBlog" });
  }
