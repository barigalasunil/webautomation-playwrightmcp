...
export class ViFastagRechargeOnlineInstantRecharge extends BasePage {
  readonly url = "https://www.myvi.in/utilities/fastag-recharge";

  // All element locators are generated dynamically using locator strategies

  get headingRechargeYourFastagInSeconds(): Locator {
    return this.page.getByRole('heading', { name: "recharge your FASTag in seconds" });
  }

  get link0(): Locator {
    return this.page.locator('a[href="https://www.myvi.in/utilities/fastag-recharge#"]');
  }
  ...
  get buttonProceedToChooseFastagBank(): Locator {
    return this.page.getByRole('button', { name: "proceed to choose FASTag bank" });
  }
  ...
  get inputSearchYourFastagIssuer(): Locator {
    return this.page.getByPlaceholder("search your FASTag issuer");
  }
