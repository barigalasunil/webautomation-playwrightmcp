...
import { ViLoanEmiPaymentQuickSecureOnlinePayment } from '../../../pages/generated/www-myvi-in/ViLoanEmiPaymentQuickSecureOnlinePayment.page';
...
test.describe("https://www.myvi.in/ - Vi Loan EMI Payment | Quick & Secure Online Payment - Regression Tests", () => {
  let appPage: ViLoanEmiPaymentQuickSecureOnlinePayment;

  test.beforeEach(async ({ page }) => {
    appPage = new ViLoanEmiPaymentQuickSecureOnlinePayment(page);
    await appPage.open();
  });

  test("Verify that Vi Loan EMI Payment | Quick & Secure Online Payment loads successfully @regression", async ({ page }, testInfo) => {
    await label('suite', "Regression Test Suite");
    await label('url', "https://www.myvi.in/");
    await label('domain', "www.myvi.in");
    await feature("Vi Loan EMI Payment | Quick & Secure Online Payment");
    ...
    const evidence = createEvidence({
      ...
      pageName: "Vi Loan EMI Payment | Quick & Secure Online Payment",
      pageUrl: "https://www.myvi.in/utilities/loan-payment",
    ...
    await test.step("Verify the URL is correct", async () => {
      await expect(appPage.page).toHaveURL(/https:\/\/www\.myvi\.in\/utilities\/loan\-payment/);
      evidence.validationsPerformed.push("Verified URL is correct");
    });

    await test.step("Capture screenshot evidence", async () => {
      const screenshotPath = await captureTestScreenshot(page, testInfo, "Vi Loan EMI Payment | Quick & Secure Online Payment - Final Evidence", "www.myvi.in");
      evidence.screenshots.push(screenshotPath);
    });

    await attachExecutionSummary(evidence, page, testInfo);
  });
  test("Verify that 1 Heading is present on Vi Loan EMI Payment | Quick & Secure Online Payment @regression", async ({ page }, testInfo) => {
    await label('suite', "Regression Test Suite");
    await label('url', "https://www.myvi.in/");
    await label('domain', "www.myvi.in");
    await feature("Vi Loan EMI Payment | Quick & Secure Online Payment");
    ...
    await test.step("Verify that the heading 'pay your loan EMI in seconds' exists in the DOM", async () => {
      await expect(appPage.headingPayYourLoanEmiInSeconds.first()).toBeAttached({ timeout: 5000 });
      evidence.validationsPerformed.push("Verify that the heading 'pay your loan EMI in seconds' exists in the DOM");
    });

    await test.step("Capture screenshot evidence", async () => {
      const screenshotPath = await captureTestScreenshot(page, testInfo, "Vi Loan EMI Payment | Quick & Secure Online Payment - Heading Verification", "www.myvi.in");
      evidence.screenshots.push(screenshotPath);
    });

    await attachExecutionSummary(evidence, page, testInfo);
  });
  test("Verify that 158 Links are present on Vi Loan EMI Payment | Quick & Secure Online Payment @regression", async ({ page }, testInfo) => {
    await label('suite', "Regression Test Suite");
    await label('url', "https://www.myvi.in/");
    await label('domain', "www.myvi.in");
    await feature("Vi Loan EMI Payment | Quick & Secure Online Payment");
    ...
    await test.step("Capture screenshot evidence", async () => {
      const screenshotPath = await captureTestScreenshot(page, testInfo, "Vi Loan EMI Payment | Quick & Secure Online Payment - Link Verification", "www.myvi.in");
      evidence.screenshots.push(screenshotPath);
    });

    await attachExecutionSummary(evidence, page, testInfo);
  });
  test("Verify that 19 Buttons are present on Vi Loan EMI Payment | Quick & Secure Online Payment @regression", async ({ page }, testInfo) => {
    await label('suite', "Regression Test Suite");
    await label('url', "https://www.myvi.in/");
    await label('domain', "www.myvi.in");
    await feature("Vi Loan EMI Payment | Quick & Secure Online Payment");
    ...
    await test.step("Capture screenshot evidence", async () => {
      const screenshotPath = await captureTestScreenshot(page, testInfo, "Vi Loan EMI Payment | Quick & Secure Online Payment - Button Verification", "www.myvi.in");
      evidence.screenshots.push(screenshotPath);
    });

    await attachExecutionSummary(evidence, page, testInfo);
  });
  test("Verify that 37 Inputs are present on Vi Loan EMI Payment | Quick & Secure Online Payment @regression", async ({ page }, testInfo) => {
    await label('suite', "Regression Test Suite");
    await label('url', "https://www.myvi.in/");
    await label('domain', "www.myvi.in");
    await feature("Vi Loan EMI Payment | Quick & Secure Online Payment");
    ...
    await test.step("Capture screenshot evidence", async () => {
      const screenshotPath = await captureTestScreenshot(page, testInfo, "Vi Loan EMI Payment | Quick & Secure Online Payment - Input Verification", "www.myvi.in");
      evidence.screenshots.push(screenshotPath);
    });

    await attachExecutionSummary(evidence, page, testInfo);
  });
  test("Verify that 2 Forms are present on Vi Loan EMI Payment | Quick & Secure Online Payment @regression", async ({ page }, testInfo) => {
    await label('suite', "Regression Test Suite");
    await label('url', "https://www.myvi.in/");
    await label('domain', "www.myvi.in");
    await feature("Vi Loan EMI Payment | Quick & Secure Online Payment");
    ...
    await test.step("Capture screenshot evidence", async () => {
      const screenshotPath = await captureTestScreenshot(page, testInfo, "Vi Loan EMI Payment | Quick & Secure Online Payment - Form Verification", "www.myvi.in");
      evidence.screenshots.push(screenshotPath);
    });

    await attachExecutionSummary(evidence, page, testInfo);
  });
  test("Verify that 1 Menu is present on Vi Loan EMI Payment | Quick & Secure Online Payment @regression", async ({ page }, testInfo) => {
    await label('suite', "Regression Test Suite");
    await label('url', "https://www.myvi.in/");
    await label('domain', "www.myvi.in");
    await feature("Vi Loan EMI Payment | Quick & Secure Online Payment");
    ...
    await test.step("Capture screenshot evidence", async () => {
      const screenshotPath = await captureTestScreenshot(page, testInfo, "Vi Loan EMI Payment | Quick & Secure Online Payment - Menu Verification", "www.myvi.in");
      evidence.screenshots.push(screenshotPath);
    });
