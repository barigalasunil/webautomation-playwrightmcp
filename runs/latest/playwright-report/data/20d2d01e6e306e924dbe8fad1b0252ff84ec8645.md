...
- toolbar:
  - listbox:
    - 'option "count {properties.mainimagealt9} count {properties.mainimagealt10}"':
      - img "count"
      - 'img "{properties.mainimagealt9}"'
      - img "count"
      - 'img "{properties.mainimagealt10}"'
  - tablist:
    - listitem:
      - button "3"
...
- button "see more"
- heading "Vi Movies & TV - All in One OTT App" [level=3]
