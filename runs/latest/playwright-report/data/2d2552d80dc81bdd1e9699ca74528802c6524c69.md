...
- Name: www-myvi-in\ViBusinessB2bMobilityConnectivitySecurityIotCloud.spec.ts >> https://www.myvi.in/ - Vi Business - B2B: Mobility, Connectivity, Security, IoT & Cloud - Regression Tests >> Verify that 179 Links are present on Vi Business - B2B: Mobility, Connectivity, Security, IoT & Cloud @regression
- Location: tests\generated\www-myvi-in\ViBusinessB2bMobilityConnectivitySecurityIotCloud.spec.ts:96:3
...
Locator: locator('a[href="https://www.myvi.in/business"]').first()
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('a[href="https://www.myvi.in/business"]').first()
