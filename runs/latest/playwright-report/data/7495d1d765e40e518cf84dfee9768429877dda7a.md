...
- Name: www-myvi-in\ViBusinessB2bMobilityConnectivitySecurityIotCloud.spec.ts >> https://www.myvi.in/ - Vi Business - B2B: Mobility, Connectivity, Security, IoT & Cloud - Regression Tests >> Verify that 1 Menu is present on Vi Business - B2B: Mobility, Connectivity, Security, IoT & Cloud @regression
- Location: tests\generated\www-myvi-in\ViBusinessB2bMobilityConnectivitySecurityIotCloud.spec.ts:234:3
...
Locator: getByRole('navigation', { name: 'Vi Business Assist IoT Smart Central Dashboard My Account Products & Solutions F' }).first()
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('navigation', { name: 'Vi Business Assist IoT Smart Central Dashboard My Account Products & Solutions F' }).first()
...
- toolbar:
  - listbox:
    - option "5G banner order now":
      - link "5G banner":
        - /url: /business/enterprise-mobility/5g-network
        - img "5G banner"
      - link "5G banner":
        - /url: /business/enterprise-mobility/5g-network
        - paragraph
...
- button "Previous"
- listbox:
  - 'option "Agentic AI in Contact Centers: Trends & Benefits for 2026 by Vi Business Agentic AI in Contact Centers: Trends & Benefits for 2026 - Vi Business Explore agentic AI in contact centers, key CCaaS trends for 2026, and how businesses can improve customer engagement ✓ automation ✓ efficiency across channels. calender 25th May, 2026 arrow"':
    - 'img "Agentic AI in Contact Centers: Trends & Benefits for 2026 by Vi Business"'
    - 'heading "Agentic AI in Contact Centers: Trends & Benefits for 2026 - Vi Business" [level=3]'
    - paragraph: Explore agentic AI in contact centers, key CCaaS trends for 2026, and how businesses can improve customer engagement ✓ automation ✓ efficiency across channels.
    - paragraph:
      - img "calender"
      - text: 25th May, 2026
    - img "arrow"
