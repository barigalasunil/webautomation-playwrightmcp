...
- Name: www-myvi-in\GetANewViPrepaidSimCardIn3SimpleStepsBuyNewSim.spec.ts >> https://www.myvi.in/ - Get a New Vi Prepaid SIM Card in 3 Simple Steps - Buy New Sim - Regression Tests >> Verify that 37 Links are present on Get a New Vi Prepaid SIM Card in 3 Simple Steps - Buy New Sim @regression
- Location: tests\generated\www-myvi-in\GetANewViPrepaidSimCardIn3SimpleStepsBuyNewSim.spec.ts:96:3
...
- toolbar:
  - listbox:
    - option "the future is exciting. Ready? Switch to Vi with no change in number and no physical documents required. port my number >>":
      - heading "the future is exciting. Ready?" [level=2]
      - paragraph: Switch to Vi with no change in number and no physical documents required.
      - paragraph: port my number
      - text: ">>"
      - img
  - tablist:
    - listitem:
