...
- Name: www-myvi-in\BuyANewVi4gSimCardOnlineAndGetAFreeDelivery.spec.ts >> https://www.myvi.in/ - Buy a New Vi 4g SIM Card Online and Get a Free Delivery - Regression Tests >> Verify that 2 Menus are present on Buy a New Vi 4g SIM Card Online and Get a Free Delivery @regression
- Location: tests\generated\www-myvi-in\BuyANewVi4gSimCardOnlineAndGetAFreeDelivery.spec.ts:264:3
...
Locator: getByRole('navigation', { name: 'Home New Connection Buy New 4G SIM Online' }).first()
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('navigation', { name: 'Home New Connection Buy New 4G SIM Online' }).first()
