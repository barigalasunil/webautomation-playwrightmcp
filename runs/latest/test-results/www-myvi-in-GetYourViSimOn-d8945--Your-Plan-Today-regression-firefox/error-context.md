...
- Name: www-myvi-in\GetYourViSimOnlineAndEnjoyFreeDeliveryChooseYourPlanToday.spec.ts >> https://www.myvi.in/ - Get your Vi Sim Online and Enjoy Free Delivery | Choose Your Plan Today - Regression Tests >> Verify that 5 Inputs are present on Get your Vi Sim Online and Enjoy Free Delivery | Choose Your Plan Today @regression
- Location: tests\generated\www-myvi-in\GetYourViSimOnlineAndEnjoyFreeDeliveryChooseYourPlanToday.spec.ts:188:3
...
> 207 |       await expect(appPage.inputFaqDrawer.first()).toBeAttached({ timeout: 5000 });
  ...
  228 |       const screenshotPath = await captureTestScreenshot(page, testInfo, "Get your Vi Sim Online and Enjoy Free Delivery | Choose Your Plan Today - Input Verification", "www.myvi.in");
