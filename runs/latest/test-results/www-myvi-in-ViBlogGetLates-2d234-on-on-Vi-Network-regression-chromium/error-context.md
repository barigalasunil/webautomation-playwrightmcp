...
- Name: www-myvi-in\ViBlogGetLatestNewsInformationOnViNetwork.spec.ts >> https://www.myvi.in/ - Vi Blog | Get Latest News & Information on Vi Network - Regression Tests >> Verify that 5 Buttons are present on Vi Blog | Get Latest News & Information on Vi Network @regression
- Location: tests\generated\www-myvi-in\ViBlogGetLatestNewsInformationOnViNetwork.spec.ts:142:3
...
- img
- 'img "Island Hopping in Thailand: Popular Recommendations"'
- paragraph: "Island Hopping in Thailand: Popular Recommendations"
- paragraph: International roaming
- paragraph:
  - img "calendar-grey"
  - text: June 09, 2026
- img "arrow icon"
- img "Enjoy Flexibility with Weekly, Fortnightly, and Monthly Plans with Vi International Roaming"
- paragraph: Enjoy Flexibility with Weekly, Fortnightly, and Monthly Plans with Vi International Roaming
- paragraph: International roaming
- paragraph:
  - img "calendar-grey"
  - text: June 09, 2026
- img "arrow icon"
- img "Which Prepaid Plan is The Best for 5G users in 2026?"
- paragraph: Which Prepaid Plan is The Best for 5G users in 2026?
- paragraph: quick bytes
- paragraph:
  - img "calendar-grey"
  - text: June 09, 2026
- img "arrow icon"
- 'img "India A Tri-Series in Sri Lanka 2026: How to Watch it Online with Vi"'
- paragraph: "India A Tri-Series in Sri Lanka 2026: How to Watch it Online with Vi"
- paragraph: sports
- paragraph:
  - img "calendar-grey"
  - text: June 09, 2026
...
- navigation "Pagination":
  ...
  - listitem:
    - link "Page 190":
      - /url: https://www.myvi.in/page/190
      - text: "190"
  - listitem:
    - link "Page 191":
