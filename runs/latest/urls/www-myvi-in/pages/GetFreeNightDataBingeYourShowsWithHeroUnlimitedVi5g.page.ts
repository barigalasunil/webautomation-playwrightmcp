...
export class GetFreeNightDataBingeYourShowsWithHeroUnlimitedVi5g extends BasePage {
  readonly url = "https://www.myvi.in/prepaid/hero-unlimited-and-weekend-data-rollover";

  // All element locators are generated dynamically using locator strategies

  get headingViHeroUnlimited(): Locator {
    return this.page.getByRole('heading', { name: "Vi Hero Unlimited" });
  }

  get headingViHeroUnlimitedDataBenefits(): Locator {
    return this.page.getByRole('heading', { name: "Vi hero unlimited data benefits" });
  }

  get headingUpTo2gbOfBackupDataEveryMonth(): Locator {
    return this.page.getByRole('heading', { name: "Up to 2GB of backup Data every month!" });
  }

  get headingCarryUnusedDataIntoTheWeekend(): Locator {
    return this.page.getByRole('heading', { name: "carry unused data into the weekend" });
  }

  get headingBingeAllNightWithoutAnyLimits(): Locator {
    return this.page.getByRole('heading', { name: "binge all night, without any limits" });
  }

  get headingBingeAllNightDataDataDelightsAndDataRolloverFaqs(): Locator {
    return this.page.getByRole('heading', { name: "binge all night data, data delights and data rollover FAQs" });
  }

  get headingBingeAllNightDataOfferTnc(): Locator {
    return this.page.getByRole('heading', { name: "binge all night data offer TnC" });
  }

  get headingWeekendDataRolloverTnc(): Locator {
    return this.page.getByRole('heading', { name: "weekend data rollover TnC" });
  }

  get headingDataDelightsOfferTnc(): Locator {
    return this.page.getByRole('heading', { name: "data delights offer TnC" });
  }
  ...
  get linkHeroUnlimited(): Locator {
    return this.page.getByRole('link', { name: "Hero Unlimited" });
  }
  ...
  get linkDownloadViApp1(): Locator {
    return this.page.getByRole('link', { name: "Download Vi App" });
  }

  get linkDownloadViApp2(): Locator {
    return this.page.getByRole('link', { name: "Download Vi App" });
  }

  get linkDownloadViApp3(): Locator {
    return this.page.getByRole('link', { name: "Download Vi App" });
  }

  get linkUnlimitedDataPlans(): Locator {
    return this.page.getByRole('link', { name: "unlimited data plans" });
  }
  ...
  get buttonViHeroUnlimited(): Locator {
    return this.page.getByRole('button', { name: "Vi Hero Unlimited" });
  }

  get buttonDataDelight(): Locator {
    return this.page.getByRole('button', { name: "Data Delight" });
  }

  get buttonWeekendDataRollover(): Locator {
    return this.page.getByRole('button', { name: "Weekend data Rollover" });
  }

  get buttonBingeAllNight(): Locator {
    return this.page.getByRole('button', { name: "Binge All Night" });
  }
  ...
  get buttonDownloadViApp1(): Locator {
    return this.page.getByRole('button', { name: "Download Vi App" });
  }

  get buttonDownloadViApp2(): Locator {
    return this.page.getByRole('button', { name: "Download Vi App" });
  }

  get buttonDownloadViApp3(): Locator {
    return this.page.getByRole('button', { name: "Download Vi App" });
  }
  ...
  get buttonExploreAllPacks(): Locator {
    return this.page.getByRole('button', { name: "explore all packs" });
  }
  ...
  get menuHomeprepaidheroUnlimited(): Locator {
    return this.page.getByRole('navigation', { name: "HomeprepaidHero Unlimited" });
  }
