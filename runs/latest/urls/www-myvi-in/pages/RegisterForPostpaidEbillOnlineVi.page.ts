...
export class RegisterForPostpaidEbillOnlineVi extends BasePage {
  readonly url = "https://www.myvi.in/online-ebill-registration";

  // All element locators are generated dynamically using locator strategies

  get headingEBillRegistration(): Locator {
    return this.page.getByRole('heading', { name: "E-bill registration" });
  }

  get headingActivateEbillGoPaperlessGoGreen(): Locator {
    return this.page.getByRole('heading', { name: "Activate Ebill. Go Paperless, Go Green" });
  }

  get headingHeyJustToMakeSureItSYou(): Locator {
    return this.page.getByRole('heading', { name: "hey, just to make sure it’s you" });
  }

  get link0(): Locator {
    return this.page.locator('a[href="https://www.myvi.in/online-ebill-registration#"]');
  }
  ...
  get linkOnlineEBillRegistrationForm(): Locator {
    return this.page.getByRole('link', { name: "Online E-Bill Registration Form" });
  }
  ...
  get inputPostpaidMobileNumber(): Locator {
    return this.page.getByPlaceholder("Postpaid Mobile Number");
  }
  ...
  get inputOtpOne(): Locator {
    return this.page.locator('input[name="otp-one"]');
  }

  get inputOtpTwo(): Locator {
    return this.page.locator('input[name="otp-two"]');
  }

  get inputOtpThree(): Locator {
    return this.page.locator('input[name="otp-three"]');
  }

  get inputOtpFour(): Locator {
    return this.page.locator('input[name="otp-four"]');
  }
  ...
  get inputOtpwrong(): Locator {
    return this.page.locator('input[name="otpWrong"]');
  }

  get inputCname(): Locator {
    return this.page.locator('input[name="Cname"]');
  }

  get inputCemail(): Locator {
    return this.page.locator('input[name="Cemail"]');
  }

  get inputCmsisdn(): Locator {
    return this.page.locator('input[name="Cmsisdn"]');
  }

  get inputCcircle(): Locator {
    return this.page.locator('input[name="Ccircle"]');
  }

  get inputCcircleid(): Locator {
    return this.page.locator('input[name="CcircleId"]');
  }

  get inputCismigrated(): Locator {
    return this.page.locator('input[name="CisMigrated"]');
  }

  get inputCprovider(): Locator {
    return this.page.locator('input[name="Cprovider"]');
  }

  get inputClob(): Locator {
    return this.page.locator('input[name="Clob"]');
  }

  get inputCtmcode(): Locator {
    return this.page.locator('input[name="CtmCode"]');
  }

  get inputEbillstatus(): Locator {
    return this.page.locator('input[name="ebillStatus"]');
  }

  get inputRefreshcache(): Locator {
    return this.page.locator('input[name="refreshcache"]');
  }

  get inputLoggedinuser(): Locator {
    return this.page.locator('input[name="loggedInUser"]');
  }

  get inputError12(): Locator {
    return this.page.locator('input[name="error12"]');
  }
  ...
  get form3(): Locator {
    return this.page.locator('form#ebillemailvalidation');
  }
  ...
  get menuHomeOnlineEBillRegistrationForm(): Locator {
    return this.page.getByRole('navigation', { name: "Home Online E-Bill Registration Form" });
  }
